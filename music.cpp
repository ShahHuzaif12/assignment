    ...
    switch(i)
    {
        case 1:
        {
           ...
           if (purcahse <= 100)
           {
              ...
              sales_tax = (5 * (purcahse - discount)) / 100;                       //discount calculation occurs before the addition of the 5% sales 
           ...
           {
              discount = (purcahse * 12)/100;                //If the  purchase total is $100 or higher, In that case, the discount is 12%.
